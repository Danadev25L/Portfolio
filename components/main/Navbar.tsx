        ...
        <div className="w-full h-full flex flex-row items-center justify-between m-auto">
          ...
          <div className="hidden lg:flex w-[500px] h-full items-center justify-between">
            <div className="flex items-center justify-between w-full h-auto border border-[#7042f861] bg-[#0300145e] px-[10px] md:px-[20px] py-[5px] md:py-[10px] rounded-full text-gray-200 text-sm md:text-base">
              <Link href="#about-me" className={`cursor-pointer ${activeSection === "about-me" ? "text-[#7042f8] font-medium" : ""}`}>
                About me
              </Link>
              <Link href="#skills" className={`cursor-pointer ${activeSection === "skills" ? "text-[#7042f8] font-medium" : ""}`}>
                Skills
              </Link>
              <Link href="#projects" className={`cursor-pointer ${activeSection === "projects" ? "text-[#7042f8] font-medium" : ""}`}>
                Projects
              </Link>
            </div>
          </div>
